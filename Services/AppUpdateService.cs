...
public sealed class AppUpdateService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var destinationPath = Path.Combine(_pendingDirectoryPath, $"Acta-{safeVersion}.exe");
        ...
        request.Headers.UserAgent.ParseAdd("Acta-Updater/1.0");
    ...
    private static HttpClient CreateHttpClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.ParseAdd("Acta-Updater/1.0");
    ...
    private string EnsureUpdaterExecutable()
    {
        ...
        var updaterPath = Path.Combine(_updaterDirectoryPath, "ActaUpdater.exe");
