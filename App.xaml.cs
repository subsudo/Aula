...
public partial class App : Application
{
    ...
    private static readonly string SingleInstanceMutexName = $@"Local\Aula.SingleInstance.{Environment.UserName}";
    private static readonly string SingleInstancePipeName = $"Aula.SingleInstance.{Environment.UserName}";
    ...
    public static void ApplyUiScale(int level)
    {
        ...
        switch (level)
        {
            case 1:
                ...
                SetResource(resources, "Ui.Padding.SearchTextBox", new Thickness(30, 5, 66, 5));
            ...
            case 2:
                ...
                SetResource(resources, "Ui.Padding.SearchTextBox", new Thickness(30, 5, 68, 5));
            ...
            case 3:
                ...
                SetResource(resources, "Ui.Padding.SecondaryButton", new Thickness(6, 2, 6, 2));
                SetResource(resources, "Ui.Padding.SearchTextBox", new Thickness(31, 6, 70, 6));
            ...
            case 4:
                ...
                SetResource(resources, "Ui.Padding.SearchTextBox", new Thickness(32, 8, 74, 8));
            ...
            case 5:
                ...
                SetResource(resources, "Ui.Padding.SearchTextBox", new Thickness(33, 9, 80, 9));
