...
public class Participant : INotifyPropertyChanged
{
    ...
    private bool _canOpenAkteLb;
    private bool _canInsertEntryBi;
    private bool _canInsertEntryLb;
    ...
    public bool CanOpenAkteLb
    {
        get => _canOpenAkteLb;
        set => SetField(ref _canOpenAkteLb, value);
    }
    ...
    public bool CanInsertEntryLb
    {
        get => _canInsertEntryLb;
        set => SetField(ref _canInsertEntryLb, value);
    }
